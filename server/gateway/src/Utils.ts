...
export function array2Obj(array: Array<Record<string,string>>, key:string) : Record<string,Record<string,string>> {
    const initialValue = {};
    return array.reduce((obj:Record<string,Record<string,string>>, item:Record<string,string>) => {
        return {
            ...obj,
            [item[key]]: item,
        };
